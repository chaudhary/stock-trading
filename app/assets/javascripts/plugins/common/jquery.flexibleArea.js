  ...
  var methods = {
    init : function() {
      ...
      return this.each(function(){
        ...
        if(this.classList.contains('flexible')) return false;
        ...
        function setHeightAndOverflow(){
          ...
          var overflow = 'hidden';
          var height = hasBoxModel ? cloneHeight + heightCompensation : cloneHeight;
          if (height > maxheight) {
            height = maxheight;
            overflow = 'auto';
        ...
        $textarea.bind('max-height-changed',function(){
          maxheight = parseInt($textarea.css('max-height'), 10) > -1 ? parseInt($textarea.css('max-height'), 10) : Number.MAX_VALUE;
        });
